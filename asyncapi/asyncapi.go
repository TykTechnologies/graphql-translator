...
// ParseAsyncAPIDocument parses the input byte slice as an AsyncAPI document and returns an AsyncAPI object and an error.
// The input byte slice should contain the AsyncAPI document in JSON/YAML format.
